...
namespace PrestacaoNuvem.Api.Infrastructure.Migrations
{
    ...
    [Migration("20250703191259_AddAgendaEventoModule")]
    partial class AddAgendaEventoModule
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PrestacaoNuvem.Api.Domain.Model.AgendaEvento", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("PrestacaoNuvem.Api.Domain.Model.AgendaEventoFuncionario", b =>
                {
                    b.Property<Guid>("AgendaEventoId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("FuncionarioId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<string>("CorIndicativa")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.HasKey("AgendaEventoId", "FuncionarioId");

                    b.ToTable("AgendaEventoFuncionarios");
                });
            ...
            modelBuilder.Entity("PrestacaoNuvem.Api.Domain.Model.AgendaEventoFuncionario", b =>
                {
                    b.HasOne("PrestacaoNuvem.Api.Domain.Model.AgendaEvento", "AgendaEvento")
                        .WithMany("Funcionarios")
                        .HasForeignKey("AgendaEventoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("AgendaEvento");
                });
