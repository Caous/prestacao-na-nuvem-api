...
public class ClienteControllerTest
{
    ...
    {
        return new List<Cliente>() { new Cliente() { CPF = "123456789", Email = "teste@test.com.br", Nome = "Teste", Telefone = "11999999999", Id = Guid.NewGuid() } };
    }


    private static Cliente CriaClienteFake(Guid? Id)
    {
        return new Cliente() { CPF = "123456789", Email = "teste@test.com.br", Nome = "Teste", Telefone = "11999999999", Id = Id.HasValue ? Id.Value : Guid.Empty };
    }

    private static ClienteDto CriaClienteDtoFake(Guid? Id)
    {
        return new ClienteDto() { CPF = "123456789", Email = "teste@test.com.br", Nome = "Teste", Telefone = "11999999999", Id = Id.HasValue ? Id.Value : Guid.Empty };
    }
}
